# -*- coding: utf-8 -*-
"""
Created on Sat Mar  5 17:59:17 2022
...
def table_creation_user_accounts():
    ...
    cursor=mycon.cursor()
    mycon.autocommit=True
    s1="create table user_accounts1(fname varchar(100),lname varchar(100),user_name varchar(100) ,password varchar(100) primary key, phno varchar(15),gender varchar(50),dob varchar(50),age varchar(4))"
    cursor.execute(s1)
